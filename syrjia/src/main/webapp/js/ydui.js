...
!function (window) {
    ...
    CitySelect.prototype.createDOM = function () {
        ...
        _this.$cityElement.on('click.ydui.cityselect', '.cancel', function () {
        	$(".mask-black").remove();
...
//            		defaultSet.city = ",全部";
//            		defaultSet.area = "";
//            		console.log($nav.eq(0).html());
//            		console.log($nav.eq(1).html());
//            		console.log($nav.eq(2).html());
            		_this.returnValue();
            	}
