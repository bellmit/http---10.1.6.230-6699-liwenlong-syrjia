    ...
    r = function() {
        ...
        return o(e, null, [{
            ...
            value: function(n, t, i) {
                for (var o = ["webkit", "moz", "MS", "o", ""], r = 0; r < o.length; r++) o[r] || (t = t.toLowerCase()),
                e.addEvent(n, o[r] + t, i)
            }
        },
        {
            key: "addEvent",
...
function(e, n, t) {
    ...
    default(t),
        y = new f.
    default(t);
      /*  var i = $(".ui-tab .ui-tab-nav").offset(),
        o = p.
    default.screenHeight() - i.top - i.height;
        $(".ui-tab-content").height(o),
    ...
    var r = function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                this.player.on("play",
                function(e) {
                	$(".prism-hide").addClass("prism-loading").removeClass("prism-hide");
                }),
                ...
                function(n) {
                    if (e._firstFullscreen) e.player.cancelFullScreen(),
                    e._firstFullscreen = !1;
                    else {
                        $(e.player.el()).find("video").addClass("center")
                    }
                }),
                this.player.on("x5cancelFullScreen",
                function(n) {
                    var t = e.player.fullscreenService;
                    t.getIsFullScreen() && t.cancelFullScreen()
                }),
...
function(e, n, t) {
    ...
    var s = function() {
        function e(n, t) {
            ...
            o(this, e),
            this.comments = [],
            this.liveComment = new l.
        default(n, t);
            c.
        default.on(c.
        default.EventConstant.Comments_Sended,
            function(e, n) {
                i.add(n)
            })
        }
...
function(e, n, t) {
    ...
    f = function() {
        function e(n) {
            ...
            o(this, e),
            this.animateContainer = $(s),
            n.append(this.animateContainer),
            this.imgNames = t,
            this.index = 0;
            var i = this;
            c.
        default.on(c.
        default.EventConstant.Favoriation_Sended,
            function() {
                i.favoriate()
            })
        }
        return r(e, [{
            ...
            value: function() {
                ...
                this.index++,
                l.
            default.prefixedEvent(n[0], "animationend",
                function() {
                    n.remove()
                })
            }
