...
public class MemberController {
	...
	public Map<String,Object> queryAreaList() {
		List<Map<String,Object>> provinces=memberService.queryProvinces();
		List<Map<String,Object>> citys=memberService.queryCitys(null);
		List<Map<String,Object>> areas=memberService.queryAreas(null);
	...
	public Map<String,Object> queryMember(HttpServletRequest request) {
		...
		Map<String,Object> member=memberService.queryMembersById(memberId.toString());
		if(null==member){
			return null;
		}
		return member;
