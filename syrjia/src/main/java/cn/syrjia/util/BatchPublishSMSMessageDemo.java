...
public class BatchPublishSMSMessageDemo {
	public static Boolean opera(String phone, String message, String tempCode)
			throws Exception {

		// 发短信
		SendSmsResponse response = sendSms(phone, message, tempCode);
	...
	static final String accessKeyId = SMSTemplateIdUtil.accessKeyId+"";
	static final String accessKeySecret = SMSTemplateIdUtil.accessKeySecret;

	public static SendSmsResponse sendSms(String phone, String code,
			String tempCode) throws ClientException, Exception,
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName(SMSTemplateIdUtil.accessSignName);
		// 必填:短信模板-可在短信控制台中找到
	...
	public static QuerySendDetailsResponse querySendDetails(String bizId,
			String phone) throws ClientException, Exception {
