...
public interface DoctorOrderService extends BaseServiceInterface {
	 ...
	 * @return
	 */
	public abstract Map<String, Object> checkCfOrderCount(String doctorId, String patientId);
