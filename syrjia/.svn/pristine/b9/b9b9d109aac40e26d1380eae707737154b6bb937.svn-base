...
public class AppDoctorCenterContorller {
	...
	public Map<String, Object> queryExtractBasicData(
			@RequestParam(name = "lastUpdatedAt", required = false) String lastUpdatedAt,String doctorId,String oldYztId) {
		return appDoctorService.queryExtractBasicData(lastUpdatedAt,doctorId,oldYztId);
	}
