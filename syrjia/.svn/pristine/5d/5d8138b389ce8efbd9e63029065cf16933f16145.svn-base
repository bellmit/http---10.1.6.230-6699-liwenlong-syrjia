...
public class Goods implements Serializable {
	 ...
	 * 标识
	 */
	@Join(id="identificationId",otherId="id",table="t_goods_identification",otherName="name",joinType="left")
	 ...
	 * 商品类型
	 */
	@Join(id="goodsTypeId",otherId="id",table="t_goods_type",otherName="name")
