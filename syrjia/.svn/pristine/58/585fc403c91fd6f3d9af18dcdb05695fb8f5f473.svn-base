...
import cn.syrjia.util.qcloudsms.httpclient.DefaultHTTPClient;
import cn.syrjia.util.qcloudsms.httpclient.HTTPClient;
import cn.syrjia.util.qcloudsms.httpclient.HTTPException;
import cn.syrjia.util.qcloudsms.httpclient.HTTPMethod;
import cn.syrjia.util.qcloudsms.httpclient.HTTPRequest;
